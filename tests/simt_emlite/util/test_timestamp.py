...
class TestTimestampConversion(unittest.TestCase):
    ...
    def test_invalid_string_format(self):
        ...
        self.assertRaises(TimestampConversionError, convert_timestamp_to_datetime, "invalid-date-format")

    def test_invalid_type(self):
        """Test that unsupported types raise exception"""
        self.assertRaises(TimestampConversionError, convert_timestamp_to_datetime, None)
        self.assertRaises(TimestampConversionError, convert_timestamp_to_datetime, [])
    ...
    def test_timestamp_validation_in_range(self):
        ...
        self.assertTrue(validate_timestamp_range(timestamp, test_date, tolerance_days=1))
    ...
    def test_timestamp_validation_out_of_range(self):
        ...
        self.assertFalse(validate_timestamp_range(timestamp, test_date, tolerance_days=1))
