        ...
        def select_side_effect(*args, **kwargs):
            ...
            def eq_side_effect_1(*args, **kwargs):
                ...
                def eq_side_effect_2(*args, **kwargs):
                    ...
                    serial = args[1]
                    meter_data = next(
                        (m for m in meter_registry_data if m["serial"] == serial), None
                    )
                    final_mock.execute.return_value = MockAPIResponse(
                        [meter_data] if meter_data else []
                    )
