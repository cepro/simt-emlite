...
from emlite_mediator.util.logging import logger_module_name, path_to_package_and_module

file_path = '/mediator/emlite-mediator/emlite_mediator/mediator/grpc/server.py'
expected_package = 'emlite_mediator.mediator.grpc.server'


class TestLogging(unittest.TestCase):
    def test_path_to_package_and_module(self):
        self.assertEqual(expected_package,
                         path_to_package_and_module(file_path))
